...
// UPDATED: This is the correct way to access the key in Vite
const API_KEY = import.meta.env.VITE_GEMINI_API_KEY;

if (!API_KEY) {
  // UPDATED: More helpful error message for debugging
  console.error("VITE_GEMINI_API_KEY environment variable not set. Make sure it's in your .env file and Vercel project settings.");
}
